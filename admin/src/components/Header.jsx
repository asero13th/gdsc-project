...
const Navbar = () => {
  return (
    <div className="fixed top-0 left-0 relative h-screen w-1/5 flex flex-col items-center shadow-right gap-3">
      ...
      <div className="flex flex-col gap-1">
        <button className=" btn bg-white noborder black block py-2 px-6 text-gray-400 border-white " ><a href="/admin/project" >project</a></button>
        <div className=" btn bg-white block py-2 px-6 text-gray-400 border-white "><a href="/admin/team">Teams</a></div>
        <div className=" btn bg-white block py-2 px-6 text-gray-400 border-white  "><a href="/admin/event">Events</a></div>
        <div className=" btn bg-white block py-2 px-6 text-gray-400 border-white  "><a href="/admin/sponsor">Sponsors</a></div>
      </div>
