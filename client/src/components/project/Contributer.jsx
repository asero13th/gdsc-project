  ...
  return (
    <Card style={{ width: '18rem' }} className='contributer mb-5'>
        ...
        <div className='social-media container mb-3'>
            <a href={contributer.telegram_url}><i class="fab fa-telegram social-media-icon"></i></a>
            <a href = {contributer.github_url}><i class="fab fa-github social-media-icon"></i></a>
            <a href={contributer.linkedin_url}><i class="fab fa-linkedin-in social-media-icon"></i></a>
        </div>
  </Card>
  )
}
